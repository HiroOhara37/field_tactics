...
var ASM_CONSTS = {
  8875332: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 8875387: ($0) => { performance.now = function() { return $0; }; },  
 8875435: ($0) => { performance.now = function() { return $0; }; },  
 8875483: () => { performance.now = Module['emscripten_get_now_backup']; }
};
